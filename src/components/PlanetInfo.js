...
export default function PlanetInfo ({mercury, venus, earth, mars, jupiter, saturn, uranus, neptune, isMobile}) {
    ...
    return (
        <>
            ...
            <>
                {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#419EBB'}/>) : null} 
        ...
        <>
            ...
            <>
                {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#EDA249'}/>) : null} 
            ...
            <>
                {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#545BFE'}/>) : null} 
                <PlanetOverview overview={overview} structure={structure} surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} isMobile={isMobile} color={'#545BFE'} overViewDetails={country[2].overview} img={imgEarth} name={country[2].name} size={isMobile ? "154px" : "450px"} mleft={'255px'} mright={'220px'} menuToPlanet={isMobile ? "74px" : "162px"} planetToInfo={"76px"} roTime={"0.99 DAYS"} reTime={"365.26 DAYS"} radius={"6,371 KM"} avgTemp={"16°C"} link="https://en.wikipedia.org/wiki/Venus" />

            </>
             ) : structure && earth ? (
            <>
                {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#545BFE'}/>) : null} 
                <PlanetOverview overview={overview} structure={structure} surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} isMobile={isMobile} color={'#545BFE'} overViewDetails={country[2].structure} img={imgEarth2} name={country[2].name} size={isMobile ? "154px" : "450px"} mleft={'255px'} mright={'220px'} menuToPlanet={isMobile ? "74px" : "162px"} planetToInfo={"76px"} roTime={"0.99 DAYS"} reTime={"365.26 DAYS"} radius={"6,371 KM"} avgTemp={"16°C"} link="https://en.wikipedia.org/wiki/Venus" />

            </>
             ): surface && earth ? (
            <>
                {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#545BFE'}/>) : null} 
                <PlanetOverview surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle}  isMobile={isMobile} color={"#545BFE"} overViewDetails={country[2].surface} img={imgEarth} img2={imgEarth3} name={country[2].name} size={isMobile ? "154px" : "450px"} wsize={"163px"} hsize={"199px"} ttop={"468px"} lleft={"399px"} mleft={'255px'} mright={'220px'} menuToPlanet={isMobile ? "74px" : "162px"} planetToInfo={"76px"} roTime={"0.99 DAYS"} reTime={"365.26 DAYS"} radius={"6,371 KM"} avgTemp={"16°C"} link="https://en.wikipedia.org/wiki/Venus"/>

            </>
             ) : overview && mars ? (
                <>
                    {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#CD5120'}/>) : null} 
                    <PlanetOverview overview={overview} structure={structure} surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} isMobile={isMobile} color={'#CD5120'} overViewDetails={country[3].overview} img={imgMars} name={country[3].name} size={isMobile ? "154px" : "336px"} mleft={'312px'} mright={'277px'} menuToPlanet={isMobile ? "74px" : "219px"} planetToInfo={"76px"} roTime={"1.88 YEARS"} reTime={"1.03 DAYS"} radius={"3,389.5 KM"} avgTemp={"-28°C"} link="https://en.wikipedia.org/wiki/Venus" />
                </>
                 ) : structure && mars ? (
                    <>
                    {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#CD5120'}/>) : null} 
                    <PlanetOverview overview={overview} structure={structure} surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} isMobile={isMobile} color={'#CD5120'} overViewDetails={country[3].structure} img={imgMars2} name={country[3].name} size={isMobile ? "154px" : "336px"} mleft={'312px'} mright={'277px'} menuToPlanet={isMobile ? "74px" : "219px"} planetToInfo={"76px"} roTime={"1.88 YEARS"} reTime={"1.03 DAYS"} radius={"3,389.5 KM"} avgTemp={"-28°C"} link="https://en.wikipedia.org/wiki/Venus" />
                    </>
                 ): surface && mars ? (
                    <>
                    {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#CD5120'}/>) : null} 
                    <PlanetOverview surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle}  isMobile={isMobile} color={"#CD5120"} overViewDetails={country[3].surface} img={imgMars} img2={imgMars3} name={country[3].name} size={isMobile ? "154px" : "336px"} wsize={"163px"} hsize={"1190x"} ttop={"468px"} lleft={"399px"} mleft={'312px'} mright={'277px'} menuToPlanet={isMobile ? "74px" : "219px"} planetToInfo={"76px"} roTime={"0.99 DAYS"} reTime={"365.26 DAYS"} radius={"6,371 KM"} avgTemp={"16°C"} link="https://en.wikipedia.org/wiki/Venus"/>
                    </>
                 ) : overview && jupiter ? (
                <>
                    <>
                    {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} color={'#D83A34'}/>) : null} 
                    <PlanetOverview overview={overview} structure={structure} surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} isMobile={isMobile} color={'#D83A34'} overViewDetails={country[4].overview} img={imgJupiter} name={country[4].name} size={isMobile ? "154px" : "582px"} mleft={'189px'} mright={'154px'} menuToPlanet={isMobile ? "74px" : "96px"} planetToInfo={"76px"} roTime={"9.93 HOURS"} reTime={"11.86 YEARS"} radius={"69,911 KM"} avgTemp={"-108°C"} link="https://en.wikipedia.org/wiki/Venus" />
                    </>
    
                </>
                    ) : structure && jupiter ? (
                        <>
                        {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#D83A34'}/>) : null} 
                        <PlanetOverview overview={overview} structure={structure} surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} isMobile={isMobile} color={'#D83A34'} overViewDetails={country[4].structure} img={imgJupiter2} name={country[4].name} size={isMobile ? "154px" : "582px"} mleft={'189px'} mright={'154px'} menuToPlanet={isMobile ? "74px" : "96px"} planetToInfo={"76px"} roTime={"9.93 HOURS"} reTime={"11.86 YEARS"} radius={"69,911 KM"} avgTemp={"-108°C"} link="https://en.wikipedia.org/wiki/Venus" />
                        </>
                    ): surface && jupiter ? (
                        <>
                        {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#D83A34'}/>) : null} 
                        <PlanetOverview surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle}  isMobile={isMobile} color={"#D83A34"} overViewDetails={country[4].surface} img={imgJupiter} img2={imgJupiter3} name={country[4].name} size={isMobile ? "154px" : "582px"} wsize={"163px"} hsize={"1190x"} ttop={"468px"} lleft={"399px"} mleft={'189px'} mright={'154px'} menuToPlanet={isMobile ? "74px" : "96px"} planetToInfo={"76px"} roTime={"9.93 HOURS"} reTime={"11.86 YEARS"} radius={"69,911 KM"} avgTemp={"-108°C"} link="https://en.wikipedia.org/wiki/Venus"/>
                        </>
                ) : overview && saturn ? (
                    <>
                    {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#CD5120'}/>) : null} 
                    <PlanetOverview overview={overview} structure={structure} surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} isMobile={isMobile} color={'#CD5120'} overViewDetails={country[5].overview} img={imgSaturn} name={country[5].name} size={isMobile ? "154px" : "666.09px"} mleft={'146.95px'} mright={'111.95px'} menuToPlanet={isMobile ? "74px" : "69.95px"} planetToInfo={"76px"} roTime={"9.93 HOURS"} reTime={"11.86 YEARS"} radius={"69,911 KM"} avgTemp={"-108°C"} link="https://en.wikipedia.org/wiki/Venus" />
                    </>
                        ) : structure && saturn ? (
                            <>
                            {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#CD5120'}/>) : null} 
                            <PlanetOverview overview={overview} structure={structure} surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} isMobile={isMobile} color={'#CD5120'} overViewDetails={country[5].structure} img={imgSaturn2} name={country[5].name} size={isMobile ? "154px" : "666.09px"} mleft={'146.95px'} mright={'111.95px'} menuToPlanet={isMobile ? "74px" : "69.95px"} planetToInfo={"76px"} roTime={"9.93 HOURS"} reTime={"11.86 YEARS"} radius={"69,911 KM"} avgTemp={"-108°C"} link="https://en.wikipedia.org/wiki/Venus" />
                            </>
                        ): surface && saturn ? (
                            <>
                            {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#CD5120'}/>) : null} 
                            <PlanetOverview surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle}  isMobile={isMobile} color={"#CD5120"} overViewDetails={country[5].surface} img={imgSaturn} img2={imgSaturn3} name={country[5].name} size={isMobile ? "154px" : "666.09px"} wsize={"163px"} hsize={"1190x"} ttop={"468px"} lleft={"399px"} mleft={'146.95px'} mright={'111.95px'} menuToPlanet={isMobile ? "74px" : "69.95px"} planetToInfo={"76px"} roTime={"9.93 HOURS"} reTime={"11.86 YEARS"} radius={"69,911 KM"} avgTemp={"-108°C"} link="https://en.wikipedia.org/wiki/Venus"/>
                            </>
                    ): overview && uranus ? (
                        <>
                        {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#1EC1A2'}/>) : null} 
                        <PlanetOverview overview={overview} structure={structure} surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} isMobile={isMobile} color={'#1EC1A2'} overViewDetails={country[6].overview} img={imgUranus} name={country[6].name} size={isMobile ? "154px" : "458px"} mleft={'251px'} mright={'216px'} menuToPlanet={isMobile ? "74px" : "158px"} planetToInfo={"76px"} roTime={"9.93 HOURS"} reTime={"11.86 YEARS"} radius={"69,911 KM"} avgTemp={"-108°C"} link="https://en.wikipedia.org/wiki/Venus" />
                        </>
                    ): structure && uranus ? (
                        <>
                        {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#1EC1A2'}/>) : null} 
                        <PlanetOverview overview={overview} structure={structure} surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} isMobile={isMobile} color={'#1EC1A2'} overViewDetails={country[6].structure} img={imgUranus2} name={country[6].name} size={isMobile ? "154px" : "458px"} mleft={'251px'} mright={'216px'} menuToPlanet={isMobile ? "74px" : "158px"} planetToInfo={"76px"} roTime={"9.93 HOURS"} reTime={"11.86 YEARS"} radius={"69,911 KM"} avgTemp={"-108°C"} link="https://en.wikipedia.org/wiki/Venus" />
                        </>
                    ): surface && uranus ? (
                        <>
                            {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#1EC1A2'}/>) : null} 
                            <PlanetOverview surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle}  isMobile={isMobile} color={"#1EC1A2"} overViewDetails={country[6].surface} img={imgUranus} img2={imgUranus3} name={country[6].name} size={isMobile ? "154px" : "458px"} wsize={"163px"} hsize={"1190x"} ttop={"468px"} lleft={"399px"} mleft={'251px'} mright={'216px'} menuToPlanet={isMobile ? "74px" : "158px"} planetToInfo={"76px"} roTime={"9.93 HOURS"} reTime={"11.86 YEARS"} radius={"69,911 KM"} avgTemp={"-108°C"} link="https://en.wikipedia.org/wiki/Venus"/>
                            </>
                    ): overview && neptune ? (
                        <>
                        {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#2D68F0'}/>) : null} 
                        <PlanetOverview overview={overview} structure={structure} surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} isMobile={isMobile} color={'#2D68F0'} overViewDetails={country[7].overview} img={imgNeptune} name={country[7].name} size={isMobile ? "154px" : "450px"} mleft={'255px'} mright={'220px'} menuToPlanet={isMobile ? "74px" : "162px"} planetToInfo={"76px"} roTime={"9.93 HOURS"} reTime={"11.86 YEARS"} radius={"69,911 KM"} avgTemp={"-108°C"} link="https://en.wikipedia.org/wiki/Venus" />
                        </>
                    ): structure && neptune ? (
                        <>
                        {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#2D68F0'}/>) : null} 
                        <PlanetOverview overview={overview} structure={structure} surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} isMobile={isMobile} color={'#2D68F0'} overViewDetails={country[7].overview} img={imgNeptune2} name={country[7].name} size={isMobile ? "154px" : "450px"} mleft={'255px'} mright={'220px'} menuToPlanet={isMobile ? "74px" : "162px"} planetToInfo={"76px"} roTime={"9.93 HOURS"} reTime={"11.86 YEARS"} radius={"69,911 KM"} avgTemp={"-108°C"} link="https://en.wikipedia.org/wiki/Venus" />
                        </>
                    ): surface && neptune ? (
                        <>
                        {isMobile ? (<SubMenu isMobile={isMobile} overview={overview} structure={structure} surface={surface} overviewHandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle} colors={'#2D68F0'}/>) : null} 
                        <PlanetOverview surface={surface} overviewhandle={overviewhandle} structureHandle={structureHandle} surfaceHandle={surfaceHandle}  isMobile={isMobile} color={"#2D68F0"} overViewDetails={country[7].surface} img={imgNeptune} img2={imgNeptune3} name={country[7].name} size={isMobile ? "154px" : "450px"} wsize={"163px"} hsize={"1190x"} ttop={"468px"} lleft={"399px"} mleft={'255px'} mright={'220px'} menuToPlanet={isMobile ? "74px" : "162px"} planetToInfo={"76px"} roTime={"9.93 HOURS"} reTime={"11.86 YEARS"} radius={"69,911 KM"} avgTemp={"-108°C"} link="https://en.wikipedia.org/wiki/Venus"/>
                        </>
                    ) :null
        }
        </>
